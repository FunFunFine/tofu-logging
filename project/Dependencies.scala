...
object Dependencies {
  ...
  object Tofu {
    val version = "0.10.1"
    val core = "tf.tofu" %% "tofu" % version
    val concurrent = "tf.tofu" %% "tofu-concurrent" % version
    val data = "tf.tofu" %% "tofu-data" % version
    val derivation = "tf.tofu" %% "tofu-derivation" % version
    val opticsMacro = "tf.tofu" %% "tofu-optics-macro" % version
  }
